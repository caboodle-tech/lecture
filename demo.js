    ...
    if (!(window.MathJax && MathJax.Hub)) {
      ...
      (function (d) {
        ...
        var g = MathJax.Object.Subclass(
          ...
          { id: "Jax", version: "2.7.9", directory: e + "/jax", extensionDir: e + "/extensions" }
        );
        b.InputJax = g.Subclass(
          ...
          { id: "InputJax", version: "2.7.9", directory: g.directory + "/input", extensionDir: g.extensionDir }
        );
        b.OutputJax = g.Subclass(
          ...
          { id: "OutputJax", version: "2.7.9", directory: g.directory + "/output", extensionDir: g.extensionDir, fontDir: e + (b.isPacked ? "" : "/..") + "/fonts", imageDir: e + (b.isPacked ? "" : "/..") + "/images" }
        );
        ...
        b.InputJax.Error = { id: "Error", version: "2.7.9", config: {}, sourceMenuTitle: ["Original", "Original Form"] };
      })("MathJax");
      (function (o) {
        var h = window[o];
        if (!h) {
